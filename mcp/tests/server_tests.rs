...
async fn test_server_list_tools() {
    ...
    let client = chevalier_mcp::client::McpClient::websocket("ws://127.0.0.1:18101")
        .await
...
async fn test_server_call_add_tool() {
    ...
    let client = chevalier_mcp::client::McpClient::websocket("ws://127.0.0.1:18102")
        .await
        .expect("Failed to connect");
...
async fn test_server_call_echo_tool() {
    ...
    let client = chevalier_mcp::client::McpClient::websocket("ws://127.0.0.1:18103")
        .await
        .expect("Failed to connect");
...
async fn test_server_info() {
    ...
    let client = chevalier_mcp::client::McpClient::websocket("ws://127.0.0.1:18104")
        .await
        .expect("Failed to connect");
...
async fn test_server_multiple_clients() {
    ...
    let client1 = chevalier_mcp::client::McpClient::websocket("ws://127.0.0.1:18105")
        .await
        .expect("Client 1 failed to connect");
    let client2 = chevalier_mcp::client::McpClient::websocket("ws://127.0.0.1:18105")
        .await
