...
pub const META_PORTPROXY_AUTH_TOKEN: &str = "reson.portproxy_auth_token";
...
nohup /bin/sh -c 'sleep 0.2; pkill -x portproxy || true; sleep 0.1; systemctl start portproxy.service || /usr/sbin/portproxy --server' >/tmp/reson-portproxy-upgrade.log 2>&1 &
"#;
