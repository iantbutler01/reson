...
<!-- @dive-rel: Tracks script relationships used by scripts/verify_chevalier_sandbox.sh and scripts/verify_strict_real.sh. -->
...
## Relationships
- `scripts/verify_chevalier_sandbox.sh` -> `scripts/verify_*.sh`: orchestrates strict gate order and failure semantics.
