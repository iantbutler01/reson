...
# @dive-rel: Provides checklist coverage for CHEVALIER_SANDBOX_REAL_INTEGRATION_TEST_PLAN.md item 7.5.3.
set -euo pipefail
...
CHEVALIER_SANDBOX_INTEGRATION_NODE1_ADMISSION_FROZEN=1 \
CHEVALIER_SANDBOX_INTEGRATION_NODE2_ADMISSION_FROZEN=0 \
