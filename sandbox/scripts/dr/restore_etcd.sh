...
restore_dir=""
manifest=""
name="${CHEVALIER_SANDBOX_DR_NODE_NAME:-chevalier-sandbox-dr}"
initial_cluster="${CHEVALIER_SANDBOX_DR_INITIAL_CLUSTER:-chevalier-sandbox-dr=http://127.0.0.1:2380}"
initial_advertise_peer_urls="${CHEVALIER_SANDBOX_DR_INITIAL_ADVERTISE_PEER_URLS:-http://127.0.0.1:2380}"
