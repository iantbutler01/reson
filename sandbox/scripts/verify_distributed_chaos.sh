#!/usr/bin/env bash
# @dive-file: Verifier gate script for verify_distributed_chaos contract coverage.
...
rg -n "acquire_port_lease|PortAllocationLease|/ports/" "$REPO_ROOT/crates/sandbox/src/distributed.rs" "$REPO_ROOT/crates/sandbox/src/lib.rs" >/dev/null
