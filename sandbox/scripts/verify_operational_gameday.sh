#!/usr/bin/env bash
# @dive-file: Verifier gate script for verify_operational_gameday contract coverage.
...
report_file_base="$(mktemp "/tmp/chevalier_sandbox_operational_gameday_gate.XXXXXX")"
