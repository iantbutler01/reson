...
<!-- @dive-rel: Complements specs/CHEVALIER_SANDBOX_REAL_INTEGRATION_TEST_PLAN.md section 7.7 CI requirements. -->
<!-- @dive-rel: Referenced by scripts/verify_strict_real.sh and Makefile verify-strict-real target. -->
# Chevalier Sandbox Real CI Requirements
...
- `pull_request`: run a bounded subset suitable for iterative review on KVM runners:
  - `./scripts/verify_chevalier_sandbox.sh --strict`
