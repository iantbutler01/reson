...
<!-- @dive-rel: Serves as requirement source for scripts/verify_chevalier_sandbox.sh gate ordering. -->
<!-- @dive-rel: Complements the HA contract by enumerating concrete behavioral acceptance points. -->
# Chevalier Sandbox Migration Checklist

This checklist is the locked acceptance surface for extraction from OpenBracket into `chevalier-sandbox`.
...
- [x] Run strict mode (`verify_chevalier_sandbox.sh --strict`) to completion in CI once host inputs are available.
