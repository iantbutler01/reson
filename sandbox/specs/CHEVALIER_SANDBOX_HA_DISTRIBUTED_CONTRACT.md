<!-- @dive-file: Defines the distributed HA contract, verifier expectations, and completion criteria for chevalier-sandbox. -->
<!-- @dive-rel: Drives implementation and gate scope in scripts/verify_chevalier_sandbox.sh. -->
<!-- @dive-rel: Serves as readiness source for rust integration expectations in chevalier/rust. -->
# Chevalier Sandbox HA Distributed Contract
...
Subject prefix: `chevalier.sandbox.control`

Required command subjects:

- `chevalier.sandbox.control.cmd.session.create`
- `chevalier.sandbox.control.cmd.session.attach`
- `chevalier.sandbox.control.cmd.session.discard`
- `chevalier.sandbox.control.cmd.vm.fork`
- `chevalier.sandbox.control.cmd.port.alloc`
- `chevalier.sandbox.control.cmd.port.release`
- `chevalier.sandbox.control.cmd.reconcile.run`

Required event subjects:

- `chevalier.sandbox.control.evt.session.bound`
- `chevalier.sandbox.control.evt.session.discarded`
- `chevalier.sandbox.control.evt.vm.forked`
- `chevalier.sandbox.control.evt.node.heartbeat`
- `chevalier.sandbox.control.evt.node.unhealthy`
- `chevalier.sandbox.control.evt.reconcile.completed`
- `chevalier.sandbox.control.evt.reconcile.failed`
