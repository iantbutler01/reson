...
<!-- @dive-rel: Supports specs/CHEVALIER_SANDBOX_REAL_INTEGRATION_TEST_PLAN.md section 7.7 operationalization goals. -->
...
4. Confirm the profile file and host capabilities from `specs/CHEVALIER_SANDBOX_REAL_CI_REQUIREMENTS.md`.
