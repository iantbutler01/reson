...
<!-- @dive-rel: Backed by contract test inflight_exec_rebinds_on_rpc_loss_and_runs_exactly_once in crates/sandbox/tests/facade_contract.rs. -->
...
- `cargo test -p chevalier-sandbox --test facade_contract inflight_exec_rebinds_on_rpc_loss_and_runs_exactly_once -- --nocapture`
