...
<!-- @dive-rel: Documents restore semantics implemented in crates/sandbox/src/lib.rs. -->
...
- `chevalier.execution_restore_snapshot_id`
- `chevalier.execution_restore_snapshot_name`
- `chevalier.fork_snapshot` (name fallback)
