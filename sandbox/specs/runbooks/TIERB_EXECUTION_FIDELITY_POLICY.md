...
<!-- @dive-rel: Implemented in crates/sandbox/src/lib.rs metadata classifier and failover restore policy checks. -->
...
- `chevalier.tier_b_eligible`: `true` or `false`
- `chevalier.execution_fidelity_requirement`:
