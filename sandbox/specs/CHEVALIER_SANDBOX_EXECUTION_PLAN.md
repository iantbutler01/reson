<!-- @dive-file: Execution plan summary for chevalier-sandbox migration and delivery status. -->
...
# Chevalier Sandbox Execution Plan

This document tracks implementation of the locked migration plan for `chevalier-sandbox`.
...
- Root workspace wiring for `vmd`, `portproxy`, `crates/sandbox`.
...
- `rust` smoke test expansion with env-gated session + fork flow.
