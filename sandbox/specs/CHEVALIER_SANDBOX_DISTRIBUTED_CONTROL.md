...
<!-- @dive-rel: Complements specs/CHEVALIER_SANDBOX_HA_DISTRIBUTED_CONTRACT.md with implementation-oriented control-plane details. -->
<!-- @dive-rel: Informs distributed adapter behavior in crates/sandbox/src/distributed.rs. -->
# Chevalier Sandbox Distributed Control (etcd + MQ)
...
Prefix default: `/chevalier-sandbox`
...
- Enable by setting `CHEVALIER_SANDBOX_ETCD_ENDPOINTS` (comma-separated list).
- Optional env overrides:
  - `CHEVALIER_SANDBOX_ETCD_PREFIX` (default `/chevalier-sandbox`)
  - `CHEVALIER_SANDBOX_NODE_ID` (default hostname/uuid fallback)
  - `CHEVALIER_SANDBOX_NODE_ENDPOINT` (default `http://<listen>`)
  - `CHEVALIER_SANDBOX_NODE_TTL_SECS` (default `15`)
...
Subject prefix default: `chevalier.sandbox.control`

Published lifecycle events:

- `chevalier.sandbox.control.session.bound`
- `chevalier.sandbox.control.session.discarded`
