...
<!-- @dive-rel: Extends HA readiness guarantees from specs/CHEVALIER_SANDBOX_HA_DISTRIBUTED_CONTRACT.md with higher-fidelity evidence. -->
<!-- @dive-rel: Defines new verifier gates to be orchestrated by scripts/verify_chevalier_sandbox.sh and CI profiles. -->
# Chevalier Sandbox Real Integration Testing Plan (Locked Draft)
