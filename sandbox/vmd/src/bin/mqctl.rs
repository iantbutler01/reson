// @dive-file: CLI helper for MQ/dead-letter operational workflows in chevalier-sandbox distributed control.
...
#[derive(Parser, Debug)]
#[command(name = "mqctl", about = "Chevalier sandbox MQ control utilities")]
struct Cli {
    #[arg(long)]
